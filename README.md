...
1. 提交issues，标题格式"apply: ${日期} ${事项} ${申请金额} "，例如：“apply: 20170801 杭州小型聚会餐饮费 200.00元”，并且在 issues 详情里提供更为详细的信息。
2. 由维护者中三人以上在 issues 里回复 ok。
3. 满足条件后，由 主事 将资金转出，并且将转账记录截图回复到 issues 中，同时关闭 issues
